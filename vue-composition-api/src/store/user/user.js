...
export const dispatchLogin = (store, email, password) =>
  store.dispatch('user/login', { email, password })
export const dispatchLogout = store => store.dispatch('user/logout')
export const dispatchScheduleRefreshToken = store =>
  store.dispatch('user/scheduleRefreshToken')
export const dispatchRefreshToken = store => store.dispatch('user/refreshToken')

export const getIdToken = store => store.getters['user/idToken']
export const getUserName = store => store.getters['user/userName']
export const getIsAuthenticated = store => store.getters['user/isAuthenticated']
